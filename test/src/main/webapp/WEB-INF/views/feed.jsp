							...
							<li>
								<div>
									<div class="commenterImage">
										<img src="resources/images/<%= post.getAuthor().getUsername() %>.png" />post.getAuthor().getUsername()										<img src="resources/images/<%= post.getAuthor().getUsername() %>.png" />
									</div>
				...
				<div class="detailBox">
					...
					<div class="actionBox">
						...
						<ul class="commentList">
							...
							<li>
								<div class="commentText">
									<p class=""><%= post.getContent() %></p><%= HtmlUtils.htmlEscape(post.()) %>									<p class=""><%= post.getContent() %></p>
